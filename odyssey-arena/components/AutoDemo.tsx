...
import { Swords, Mic, Zap, Sparkles, Play } from 'lucide-react';
...
const STEPS = [
  ...
  },
  {
    ...
    subtitle: 'Momentum, combos, critical hits, evolution',
    icon: Swords,
  },
  {
    duration: 2500,
    title: 'Characters Evolve',
    subtitle: 'Win battles to power up, lose to devolve',
    icon: Sparkles,
  },
  {
    duration: 2500,

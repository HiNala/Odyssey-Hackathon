      ...
      >
        ...
        <AnimatePresence mode="wait">
          {phase === 'idle' && (
            ...
            >
              <div className="rounded-2xl border border-border bg-surface p-10 max-w-lg text-center space-y-6">
                <img
                  src="/logo.svg"
                  alt="Odyssey Arena"
                ...
                <div className="flex flex-col gap-3 items-center pt-2">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={startGame}
                    className="px-8 py-3 rounded-xl bg-white text-black font-semibold text-sm transition-all hover:bg-white/90"
                  >
                    Start Game
                  </motion.button>
                  <motion.button
                    ...
                    className="px-6 py-2 rounded-lg text-text-muted hover:text-text-secondary text-xs transition-colors"
                  >
                    Demo Mode (no API)
                  </motion.button>
                </div>
            ...
            >
              <div className="w-full max-w-md">
                ...
                <div className="flex justify-center gap-2 mt-5">
                  <div
                    className={`w-2 h-2 rounded-full transition-colors ${p1.isSetupComplete ? 'bg-player1-accent' : 'bg-white/[0.08]'}`}
                  />
                  <div
                    className={`w-2 h-2 rounded-full transition-colors ${p2.isSetupComplete ? 'bg-player2-accent' : 'bg-white/[0.08]'}`}
                  />
                </div>
              </div>
